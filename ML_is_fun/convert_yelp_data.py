...
reviews_data = Path("data") / "review.json"
train_data = Path("training/fasttext_dataset_train.txt")
test_data = Path("training/fasttext_dataset_test.txt")

# What percent of data to save separately as test data
percent_test_data = 0.10

with reviews_data.open() as input, \
     train_data.open("w") as train_output, \
